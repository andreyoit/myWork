...
?>
			...
			<tr>
				<td colspan="2" align="left">
					<input type="button" onclick="javascript:run_form('add_mask', new Array('mask_name','auth_admin','auth_admin_phpinfo','auth_admin_configuration','auth_admin_add_user','auth_admin_user_list','auth_admin_remove_user','auth_admin_edit_user','auth_admin_add_page','auth_admin_edit_page','auth_admin_page_list','auth_admin_remove_page','auth_admin_remove_page','auth_admin_add_mask','auth_admin_list_masks','auth_admin_remove_mask','auth_admin_edit_mask','auth_admin_add_group','auth_admin_list_groups','auth_admin_remove_group','auth_admin_edit_group','auth_admin_activate_account','auth_admin_send_invite'<?php echo $params; ?>));" value="<?php echo GO_LABEL; ?>" />
				</td>
			</tr>
		</table>
	</form>
