		...
		<div class="page-quick-sidebar">
			<div class="nav-justified">
				<ul class="nav nav-tabs nav-justified">
					<li class="active">
						<a href="index.html#quick_sidebar_tab_1" data-toggle="tab">
						Users <span class="badge badge-danger">2</span>
						</a>
					</li>
					<li>
						<a href="index.html#quick_sidebar_tab_2" data-toggle="tab">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu pull-right" role="menu">
							<li>
								<a href="index.html#quick_sidebar_tab_3" data-toggle="tab">
