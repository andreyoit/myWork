...
<div class="page-container">
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<div class="page-sidebar-menu page-sidebar-menu-light" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
						...
						<li>
							...
							<ul class="sub-menu">
								<li>
									...
									<ul class="sub-menu">
										<li>
											<a href="index.html#"><i class="icon-power"></i> Sample Link 1</a>
										</li>
										<li>
											<a href="index.html#"><i class="icon-paper-plane"></i> Sample Link 1</a>
										</li>
										<li>
											<a href="index.html#"><i class="icon-star"></i> Sample Link 1</a>
										</li>
									</ul>
								</li>
								<li>
									<a href="index.html#"><i class="icon-camera"></i> Sample Link 1</a>
								</li>
								<li>
									<a href="index.html#"><i class="icon-link"></i> Sample Link 2</a>
								</li>
								<li>
									<a href="index.html#"><i class="icon-pointer"></i> Sample Link 3</a>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="sub-menu">
								<li>
									<a href="index.html#"><i class="icon-tag"></i> Sample Link 1</a>
								</li>
								<li>
									<a href="index.html#"><i class="icon-pencil"></i> Sample Link 1</a>
								</li>
								<li>
									<a href="index.html#"><i class="icon-graph"></i> Sample Link 1</a>
								</li>
							</ul>
						</li>
						<li>
