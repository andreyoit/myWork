				...
				<div class="page-toolbar">
					<div class="btn-group">
						...
						<ul class="dropdown-menu pull-right" role="menu">
							<li>
								<a href="page_todo.html#">Action</a>
							</li>
							<li>
								<a href="page_todo.html#">Another action</a>
							</li>
							<li>
								<a href="page_todo.html#">Something else here</a>
							</li>
							<li class="divider">
							</li>
							<li>
								<a href="page_todo.html#">Separated link</a>
							</li>
						</ul>
					</div>
				</div>
								...
								<div class="portlet-body">
									<div class="row">
										...
										<div class="col-md-7 col-sm-8">
											<div class="scroller" style="max-height: 600px;" data-always-visible="0" data-rail-visible="0" data-handle-color="#dae3e7">
												<form action="page_todo.html#" class="form-horizontal">
													<!-- TASK HEAD -->
													<div class="form">
													...
													<div class="tabbable-line">
														<ul class="nav nav-tabs ">
															<li class="active">
																<a href="page_todo.html#tab_1" data-toggle="tab">
																Comments </a>
															</li>
															<li>
																<a href="page_todo.html#tab_2" data-toggle="tab">
																History </a>
															</li>
														</ul>
